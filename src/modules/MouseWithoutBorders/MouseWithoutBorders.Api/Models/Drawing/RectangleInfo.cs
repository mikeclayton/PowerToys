...
using MouseWithoutBorders.Api.Models.Styles;

using BorderStyle = MouseWithoutBorders.Api.Models.Styles.BorderStyle;

namespace MouseWithoutBorders.Api.Models.Drawing;
